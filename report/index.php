...
<head>
  ...
  <title>SMT - Downtime Report</title>
...
<body style="background: #ab8600;">
    ...
    <div id="page-top" class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header">
          <div class="row mx-0">
            <div class="col-auto px-0"><a href="index.php"><h5 class="font-weight-bold" style="margin-bottom: 5px; ">SMT Report </h5></a></div><span class="mx-2"> - </span>
            <div class="col-auto px-0"><a href="act_history.php"><h5 style="margin-bottom: 5px; color: grey;">Trouble Action Report </h5></a></div>
            <div class="col">
  ...
  $(document).ready(function(){
   ...
   {
    var dataTable = $('#andon').DataTable({
      scrollX: true,
      scrollCOllapse: true,
      columnDefs:[{width:50, targets:0},{width: 50, targets:1},
                  {width:50, targets:3},{width:50, targets:4},
                  {width:50, targets:5},{width:50, targets:6},
                  {width:50, targets:7}],
      fixedColumn: true,
      "processing": true,
      "serverSide": true,
